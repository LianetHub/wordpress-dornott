...
if ($image_id) {
	...
	$slides_html .= '<div class="product__slide swiper-slide">' . $image_html . '<span class="swiper-lazy-preloader"></span></div>';
} else {
	$slides_html .= '<div class="product__slide swiper-slide">' . wc_placeholder_img($image_size, $image_args) . '<span class="swiper-lazy-preloader"></span></div>';
}
		...
		<div class="product__body">
			...
			<div class="product__info">
				<div class="product__actions">
					<?php if (!empty($sku)) : ?>
						<div class="product__sku product-card__sku">
